...
HTML;
				...
				echo <<<HTML
						...
						<div id="esquerda" class="col-md-6">
							<form action = $action method = $method $tipo_sub>
HTML;
			}
		}
		
		public function getInputHidden($nome, $value){
			echo <<<TEXT
...
TEXT;
		...
		public function getInputTextBootstrap($label, $nome, $value, $class){
			echo <<<TEXT
				<div class=$class>
					<div class="row">
						<div class="form-group">
							<label >$label</label>
							<input type ="text" name = "$nome" value = "$value" class = "form-control" required="required">
						</div>
					</div>
				</div>
...
TEXT;
		...
		public function getInputDate($label, $nome, $for, $value, $class){
...
TEXT;
		...
		public function getInputFile($label, $name, $value){
			echo<<<FILE
				<div id="direita" class="col-md-6">
					<div class="col-md-12 ">
						<div class="row">
							<div class="form-group">
								<label>$label</label>
									<input class="form-control" type="file" name="$name" id="$name" value = $value>
